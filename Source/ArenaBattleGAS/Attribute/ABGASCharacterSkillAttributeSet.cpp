...
UABGASCharacterSkillAttributeSet::UABGASCharacterSkillAttributeSet() :
	SkillRange(800.0f),
...
void UABGASCharacterSkillAttributeSet::PreAttributeChange(const FGameplayAttribute& Attribute, float& NewValue)
{
